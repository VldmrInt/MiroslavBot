...
- Рассылка сообщений всем пользователям через команду `/broadcast` (только для администратора)
...
| `ADMIN_ID` | Telegram user ID администратора (для команды `/broadcast`) | Нет |
...
| `/broadcast <текст>` | Разослать сообщение всем пользователям (только для администратора) |
